...
!!! success "Learning Objectives"
    - Use R packages to analyze single-cell RNAseq count matrices from multiple conditions
    - Assess data quality and remove low quality cells
    - Transform the count matrices into clustered, labeled cell populations
    - Identify differentially expressed genes and differentially abundant cell types between conditions
